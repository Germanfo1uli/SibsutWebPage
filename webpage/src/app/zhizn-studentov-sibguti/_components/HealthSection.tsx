                ...
                <div className="relative overflow-hidden rounded-[40px] bg-[var(--background)] p-6 md:p-12 lg:p-16 border-4 border-[var(--foreground)] shadow-[12px_12px_0px_0px_var(--foreground)]">
                    ...
                    <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
                        <div className="lg:col-span-7 relative h-[450px] md:h-[550px] border-4 border-[var(--foreground)] shadow-[16px_16px_0px_0px_var(--foreground)] overflow-hidden bg-[var(--foreground)] group mt-2">
                            <AnimatePresence initial={false} custom={currentIndex > 0 ? 1 : -1} mode="wait">
                                ...
                                >
                                    ...
                                    <div className="absolute bottom-4 left-6 right-24">
                        ...
                        <div className="lg:col-span-5 flex flex-col gap-6">
                            ...
                            <div className="group flex flex-col gap-4 p-5 border-4 border-[var(--foreground)] bg-[var(--background)] shadow-[8px_8px_0px_0px_var(--foreground)] transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_var(--accent)]">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-black text-xl uppercase text-[var(--foreground)] leading-none mb-1">Здравпункт</h4>
                                        <div className="text-xs font-black text-[var(--accent)] uppercase tracking-wider">ГБУЗ НСО «ГП № 2»</div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2 text-[var(--foreground)]">
                                    <div className="flex items-center gap-2 text-sm font-bold">
                                        ...
                                        <span>ул. Нижегородская, 23 (вход с плаца)</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-sm font-bold">
                            ...
                            <div className="group flex flex-col gap-3 p-5 border-4 border-[var(--foreground)] bg-[var(--background)] shadow-[8px_8px_0px_0px_var(--foreground)] transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_var(--accent)]">
                                <div className="flex items-center gap-3 border-b-2 border-[var(--foreground)] pb-2">
                                    <LuUser size={20} className="text-[var(--accent)]" />
                                    <h4 className="font-black text-base uppercase tracking-tighter">Медицинский персонал</h4>
                                </div>
                                <p className="text-sm font-black uppercase leading-tight">
                                    Федосеева Ольга Васильевна
                                    <span className="block text-[10px] font-bold opacity-70 normal-case">Врач-терапевт, фельдшер</span>
                                </p>
                            </div>
                            ...
                            <div className="group flex flex-col gap-3 p-5 border-4 border-[var(--foreground)] bg-[var(--background)] shadow-[8px_8px_0px_0px_var(--foreground)] transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_var(--accent)]">
                                <div className="flex items-center gap-3 border-b-2 border-[var(--foreground)] pb-2">
                                    <LuHeart size={20} className="text-[var(--accent)]" />
                                    <h4 className="font-black text-base uppercase tracking-tighter">Психологическая помощь</h4>
                                </div>
                                <div className="space-y-2 text-sm font-black">
                                    <div className="flex justify-between items-center flex-wrap gap-1">
                                        <span>Аникина Наталья Павловна</span>
                                        <span className="text-[var(--accent)]">+7 (953) 769-86-22</span>
                                    </div>
                                    <div className="flex justify-between items-center flex-wrap gap-1">
                                        <span>Сараева Мария Юрьевна</span>
                                        <span className="text-[var(--accent)]">+7 (913) 482-04-03</span>
                                    </div>
                                </div>
                            </div>
