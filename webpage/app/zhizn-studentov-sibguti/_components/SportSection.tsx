                            ...
                            {sportHighlights.map((item, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <h4 className="font-black text-lg uppercase text-[var(--foreground)] leading-none mb-1">{item.label}</h4>
                                        <div className="text-xs font-black text-[var(--accent)] uppercase tracking-wider">{item.value}</div>
                                    </div>
                                </div>
                            ))}
